    ...
    <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
      <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl lg:max-w-xl">
        ...
        <form onSubmit={handleLogin} className="mt-6">
          ...
          <div className="mt-6">
            <button type="submit" disabled={(!email, !password)} className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-purple-700 rounded-md hover:bg-purple-600 focus:outline-none focus:bg-purple-600 disabled:bg-purple-400">
              Login
            </button>
          </div>
